...
_UI_STRINGS: dict[str, dict[str, Any]] = {
    "en": {
        ...
        "selected_files_list": "Selected Files List",
        ...
        "empty_selected_files": "No file selected yet.",
    ...
    "id": {
        ...
        "selected_files_list": "Daftar File Dipilih",
        ...
        "empty_selected_files": "Belum ada file dipilih.",
